...
export default function AdminProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 relative">
      ...
      <Link to={"/TN/products/addProduct"} className="absolute right-[25px] bottom-[25px] text-[25px]  border-[#3b82f6] border-[2px] text-[#3b82f6] p-5 rounded-xl hover:rounded-full"><FaPlus /></Link>
